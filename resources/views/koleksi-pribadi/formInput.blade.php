...
<title> Form Input Koleksi Pribadi </title>
@section('isi')
...
<div class="container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2">Form Input Koleksi Pribadi</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{route('koleksi-pribadi')}}">Data Koleksi Pribadi</a></li>
                    <li class="breadcrumb-item text-white active">Form Input Koleksi Pribadi</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="main-content-label mg-b-5">
                        Form Input Data Koleksi Pribadi
                    </div>
                    <p class="mg-b-20">Silahkan isi form di bawah ini dengan lengkap.</p>
                    <!-- message info -->
                    @include('_component.message')
                    <div class="pd-10 pd-sm-20 bg-gray-100">
                        <form action="{{ route('koleksi-pribadi-create')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <select class="form-control select2" name="user_id">
                                                @php 
                                                $koleksipribadi = DB::table('users')->select('*')->orderBy('username','ASC')->get(); 
                                                @endphp
                                                <option value="">=== pilih ===</option>
                                                @foreach($koleksipribadi as $key => $val)
                        ...
                        <a href="{{route('koleksi-pribadi')}}" class="btn btn-secondary pd-x-30 mg-t-5">
