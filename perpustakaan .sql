...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Feb 2024 pada 03.30
...
(5, '2024_01_30_045043_create_buku_table', 1),
(6, '2024_01_30_045312_create_kategoribuku_table', 1),
(7, '2024_01_30_052023_create_kategoribuku_relasi_table', 1),
(8, '2024_01_30_052116_create_ulasanbuku_table', 1),
(9, '2024_01_30_052142_create_peminjaman_table', 1),
(10, '2024_01_30_052215_create_koleksipribadi_table', 1);
...
CREATE TABLE `peminjaman` (
  ...
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `buku_id` bigint(20) UNSIGNED NOT NULL,
  `TaggalPeminjaman` date NOT NULL,
  `TaggalPengembalian` date NOT NULL,
